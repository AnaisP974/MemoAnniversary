<div class="container px-6 py-8 mx-auto">
    <div class="flex justify-between">
        <h3 class="text-3xl font-medium text-gray-700">Birthdays</h3>
        <a href="/profile?pg=new_birthday" class="border bg-indigo-100 border-indigo-400 rounded-full hover:bg-indigo-200 p-4 cursor-pointer">➕</a>
    </div>
